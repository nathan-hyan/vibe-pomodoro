...
- Name: todos.spec.ts >> Focus Tasks E2E >> demotes a task back to Next tasks
- Location: e2e/todos.spec.ts:47:3

# Error details

```
Error: locator.click: Error: strict mode violation: getByTitle('Move to Currently working on') resolved to 11 elements:
    ...
    10) <button title="Move to Currently working on" class="text-white/40 hover:text-violet-400 transition-all cursor-pointer text-sm">▲</button> aka locator('div:nth-child(10) > .flex > .text-white\\/40.hover\\:text-violet-400')
    ...
...
- generic [ref=e3]:
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e30]:
      ...
      - generic [ref=e112]:
        - heading "📊 Statistics" [level=3] [ref=e113]
        - generic [ref=e114]:
          - generic [ref=e116]:
            - generic [ref=e117]:
              - generic [ref=e118]: ⏱️
              - generic [ref=e119]: Time Worked
            - generic [ref=e120]: 0m
          - generic [ref=e122]:
            - generic [ref=e123]:
              - generic [ref=e124]: 🍅
              - generic [ref=e125]: Sessions Done
            - generic [ref=e126]: "0"
          - generic [ref=e128]:
            - generic [ref=e129]:
              - generic [ref=e130]: ✓
              - generic [ref=e131]: Tasks Done
            - generic [ref=e132]: "0"
          - generic [ref=e133]:
            - generic [ref=e134]:
              - generic [ref=e135]: 📝
              - generic [ref=e136]: Tasks Left
            - generic [ref=e137]: "13"
```
