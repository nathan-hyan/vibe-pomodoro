  ...
  return (
    <div className="lg:mb-0 mb-8 flex flex-col lg:h-full">
      ...
      <div className="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        />
        <button
          onClick={() => { addTodo(inputValue); setInputValue(""); }}
        ...
        <div className="space-y-2 lg:flex-1 lg:overflow-y-auto lg:min-h-0 overflow-y-visible max-h-48">
          {todos.map((todo, index) => (
            <div
              ...
              className={clsx(
                "flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/10 hover:bg-white/10 transition-all group cursor-move",
            ...
            >
              ...
              <span
                className={clsx(
                  ...
                  todo.completed ? "line-through text-white/50" : "text-white/90"
                )}
              >
                {todo.text}
              </span>
