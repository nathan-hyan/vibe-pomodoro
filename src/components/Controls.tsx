...
export function Controls({ state, controls }: ControlsProps) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex gap-2 sm:gap-3 max-w-xs mx-auto">
        {!isRunning ? (
          <button
            onClick={start}
            disabled={timeLeft === 0}
            className="flex-1 bg-linear-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-200 text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none cursor-pointer"
          >
          ...
          <button
            onClick={pause}
            className="flex-1 bg-linear-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-semibold py-3 sm:py-4 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-200 text-base sm:text-lg cursor-pointer"
          >
            Pause
          </button>
        )}
        ...
        <button
          ...
          className="flex-1 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold py-3 sm:py-4 rounded-xl border border-white/30 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-200 text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none cursor-pointer"
        >
          Reset
        </button>
      </div>
